...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/peter/.eclipse/org.eclipse.platform_3.6.1_1473617060/plugins/org.eclim_1.6.2'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/peter/.eclipse/org.eclipse.platform_3.6.1_1473617060'
  if has('win32unix')
