...
exe "hi Folded         start=^[[m^[[34;40m   stop=^[[m^[[32m   ctermfg=".s:blue."      ctermbg=".s:black."     guifg=blue        guibg=black         term=none".s:usebold."             cterm=none".s:usebold."              gui=none".s:usebold
...
exe "hi Unique2        start=^[[m^[[35;47m   stop=^[[m^[[32m   ctermfg=".s:magenta."   ctermbg=".s:white."     guifg=magenta     guibg=white         term=none".s:usebold."             cterm=none".s:usebold."              gui=none".s:usebold
exe "hi Unique3        start=^[[m^[[30;47m   stop=^[[m^[[32m   ctermfg=".s:black."     ctermbg=".s:white."     guifg=black       guibg=white         term=none".s:usebold."             cterm=none".s:usebold."              gui=none".s:usebold
